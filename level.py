...
class Level:
    def __init__(self):
        ...
        # get the dissplay surface
        self.display_surface = pygame.display.get_surface()
        self.game_paused = False

        # sprite group setup
        self.visible_sprites = YSortCameraGroup()
        self.obstacle_sprites_sprites = pygame.sprite.Group()
            ...
            for row_index, row in enumerate(layout):
                for col_index, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'boundary':
                            Tile((x,y),
                                 [self.visible_sprites,self.obstacle_sprites_sprites]
                                 ,'invisible')
                        if style == 'grass':
                            random_grass_image = choice(graphics['grass'])
                            Tile((x,y),[self.visible_sprites,
                                        self.obstacle_sprites_sprites,
                        ...
                        if style == 'object':
                            ...
                            Tile((x,y),[self.visible_sprites,self.obstacle_sprites_sprites],'object',surf)
